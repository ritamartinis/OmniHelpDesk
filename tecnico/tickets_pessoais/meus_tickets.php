...
// Query para buscar todos os tickets abertos por ESTE técnico
...
$tickets_tecnico = $consulta->fetchAll(PDO::FETCH_ASSOC);
?>
                    ...
                    <div class="card m-2 <?php echo ($ticket['estado'] === 'Fechado') ? 'ticket-fechado' : ''; ?> <?php echo ($ticket['estado'] === 'Cancelado') ? 'ticket-cancelado' : ''; ?>"
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                <!-- ou aparece o nome do técnico ou, se ainda não foi atribuido, a mensagem -->
