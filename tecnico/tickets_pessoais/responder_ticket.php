...
// POST das alterações do técnico ENQUANTO id_utilizador_autor
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['resposta'])) {
    ...
    $consultaHistorico->execute();
     ...
     if ($consultaHistorico->rowCount() > 0) {
        // Enviar e-mail para os intervenientes
       ...
       <p>Poderá acompanhar todo o processo na nossa plataforma.<br>
        ...
        $messageAdmin = estrutura_emails($subjectAdmin, 'Um Ticket foi Atualizado pelo Utilizador', $conteudoAdmin, $textoBotao, $linkBotao);
    ...
    header("location: /tecnico/tickets_pessoais/responder_ticket.php?id_ticket=" . $id_ticket);
    exit;
}
