...
$id_utilizador_autor = $_SESSION["id_utilizador"];
    ...
    if (empty($erro)) {
        ...
        if ($consulta->execute()) {
            ...
            $conteudoAdmin = "
                ...
                <p>Um novo ticket foi criado com os detalhes seguintes:</p>
                <ul>
            ...
            $conteudoAutor = "
                <p>Caro $nomeAutor,</p>
                <p>O seu ticket foi criado com sucesso com os seguintes detalhes:</p>
                <ul>
                    <li><strong>Assunto:</strong> $assunto</li>
                    <li><strong>Descrição:</strong> $descricao</li>
                    <li><strong>Departamento Responsável:</strong> $departamento_responsavel</li>
                        ...
                        <form id="ticketForm" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-6 d-grid">
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#confirmModal">Abrir Ticket</button>
                                </div>
                                <div class="col-sm-6 d-grid">
                                    <a class="btn btn-secondary" href="../area_tecnico.php" role="button">Cancelar</a>
                                </div>
                            </div>
                        </form>
                    </div>
