...
if (isset($_POST['id_ticket']) && is_numeric($_POST['id_ticket'])) {
    ...
    // Atualiza o estado do ticket para "Reaberto" e limpa a data de encerramento - o ticket deixa de estar fechado
    ...
    if ($consulta->execute()) {
        ...
        $subjectAdmin = "Reabriu o seu Ticket";
        ...
        <ul>
            ...
            <li><strong>Mensagem do Funcionário:</strong> Ticket reaberto</li>      
        ...
        $messageAdmin = estrutura_emails($subjectAutor, 'Reabriu o seu Ticket', $conteudoAutor, $textoBotao, $linkBotao);
        ...
        if (!$emailAdminSent || !$emailTecnicoSent) {
