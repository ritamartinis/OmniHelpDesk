...
//POST das alterações do admin ENQUANTO id_utilizador_autor
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['resposta'])) {
   ...
   if ($consultaHistorico->rowCount() > 0) {
        ...
        $subjectAdmin = "Atualizou o seu Ticket";
        $subjectTecnico = "Um Ticket foi Atualizado pelo Utilizador";
            
        $conteudoAdmin = "
        <p>Caro Administrador,</p>
        Serve o presente email para o informamos que o seu ticket, com o ID <strong>#$id_ticket</strong> foi atualizado.<p/>
       ...
       <p>Poderá acompanhar todo o processo na nossa plataforma.<br>
        Assim que o técnico responder, informá-lo-emos via e-mail.</p>";
        ...
        <ul>
            ...
            <li><strong>Prioridade:</strong> $prioridade</li>
    		<li><strong>Estado:</strong> $estado</li>
            <li><strong>Utilizador:</strong> Administrador</li>
    ...
    header("Location: /admin/tickets/responder_ticket.php?id_ticket=" . $id_ticket);
    exit;
}
...
<body>
                        ...
                        <div id="historicoComentarios" class="chat-container">
                            <?php foreach ($historico as $item): ?>
                                <div class="chat-message <?php echo ($item['id_utilizador'] == $id_utilizador) ? 'right' : ''; ?>">
                                    ...
                                    if ($item['nome_utilizador'] == 'Administrador') {
                                        $fotoPerfilPath = '../../includes/fotosdiversas/_admin.png';
                                    } else {
                                        $fotoPerfilPath = !empty($item['foto_perfil']) ? '../../includes/upload_fotosperfil/' . htmlspecialchars(basename($item['foto_perfil'])) : '../../includes/fotosdiversas/default.jpg';
                                    }
                                    ?>
                                    <img src="<?= $fotoPerfilPath; ?>" alt="Foto de Perfil">
                                    <div>
 ...
 <script>
        ...
        function validarResposta() {
            ...
            //para ver se o ticket já tem técnico atribuido e proibir que o id_utilizador_autor possa responder se n há
