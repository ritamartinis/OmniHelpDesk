...
<nav class="navbar navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="#">Área de Funcionário</a>

        <a class="nav-link active d-flex align-items-right" aria-current="page"
            href="/funcionario/area_funcionario.php">
...
<div class="offcanvas offcanvas-start bg-dark" tabindex="-1" id="offcanvasNavbar"
    ...
    <div class="offcanvas-header">
        <h5 class="offcanvas-title text-white" id="offcanvasNavbarLabel">
            <a class="nav-link" href="/funcionario/area_funcionario.php">
    ...
    <div class="offcanvas-body d-flex flex-column h-100">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/funcionario/tickets/abrir_ticket.php">
                    <i data-feather="bookmark"></i>
                    Abrir um Ticket
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/funcionario/tickets/meus_tickets.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/funcionario/dados_conta.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/funcionario/lista_faqs.php">
            ...
            <ul class="nav flex-column mb-2">
                <li class="nav-item d-flex align-items-center justify-content-between">
                    <a class="nav-link d-flex align-items-center p-0" href="#">
                        ...
                        <!-- vai buscar o nome do funcionário à bd -->
